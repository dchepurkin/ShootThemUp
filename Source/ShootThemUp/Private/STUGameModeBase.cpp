...
FLinearColor ASTUGameModeBase::DetermineColorByTeam(int32 TeamID) const
{
	...
	UE_LOG(LogSTUGameModBase, Warning, TEXT("No color for team id: %i, set to default: %s"), TeamID,
...
void ASTUGameModeBase::SetMatchState(const ESTUMatchState NewMatchState)
{
